...
If an object-language element is neither formally nor semantically segmentable and only
the metalanguage happens to lack a single-word equivalent, the underscore may be used
...
distinguishable meanings or grammatical properties, the semi-colon may be used. E.g.
...
If an object-language element is formally and semantically segmentable, but the author
does not want to show the formal segmentation (because it is irrelevant and/or to keep
the text intact), the colon may be used. E.g.
...
distinct morphological entities (e.g. bipartite stems such as Lakhota na-xʔu̧ 'hear') may
...
Infixes are generally easily identifiable as left-peripheral (as in 27) or as
rightperipheral (as in 28), and this determines the position of the gloss
...
- Schultze-Berndt, Eva. 2000. Simple and complex verbs in Jaminjung:
  A study of event categorization in an Australian language.
  Katholieke Universiteit Nijmegen Ph.D. Dissertation.
- Sneddon, James Neil. 1996. Indonesian: A comprehensive grammar. London: Routledge.
- van den Berg, Helma. 1995. A Grammar of Hunzib.
  (Lincom Studies in Caucasian Linguistics, 1.) München: Lincom Europa.
